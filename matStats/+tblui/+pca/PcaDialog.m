...
%PCADIALOG Choose options for PCA and display results of computations
%
%   Class PcaDialog
%
%   Example
...
methods
    ...
    function onShowEigenValuesTable(obj, varargin)
        ...
        createTableViewer(obj.Gui, eigenValues);
    end
    ...
    function onShowScoresTable(obj, varargin)
        ...
        createTableViewer(obj.Gui, scores);
    end
    ...
    function onShowLoadingsTable(obj, varargin)
        ...
        createTableViewer(obj.Gui, loadings);
    end
