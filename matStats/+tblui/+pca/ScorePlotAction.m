classdef ScorePlotAction < handle
%ScorePlotAction  Plot Scores of a PCA result
%
%   Class ScorePlotAction
%
%   Example
%   ScorePlotAction
%
...
%% Constructor
methods
    function obj = ScorePlotAction(pcaDlg)
...
methods
    function onButtonOK(obj, varargin)
        ...
        scorePlot(ax, pca, indX, indY, 'showNames', showNames);
    end
