classdef LoadingPlotAction < handle
%LOADINGPLOTACTION  Plot Loadings of a PCA result
%
%   Class LoadingsPlotAction
%
%   Example
%   LoadingsPlotAction
%
...
%% Constructor
methods
    function obj = LoadingPlotAction(pcaDlg)
    % Constructor for LoadingsPlotAction class
        obj.Parent = pcaDlg;
    end
...
methods
    ...
    function hf = createFigure(obj)
        ...
        nValues = size(obj.Parent.ResPca.Loadings, 1);
...
methods
    function onButtonOK(obj, varargin)
        ...
        loadingPlot(ax, pca, indX, indY, 'showNames', showNames);
