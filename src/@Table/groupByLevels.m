function res = groupByLevels(this, name, op, varargin)
%GROUPBYLEVELS Group rows according to unique values in a vector or column
%
%   TAB2 = TAB.groupByLevels(VALUES, OP)
%   VALUES is a column vector with as many elements as the number of rows
%   in the table
%   OP is a mathematical operation which computes a value from an array,
%   like 'min', 'max', 'mean'...
%
...
%   
%   TAB2 = TAB.groupByLevels(COLNAME, OP)
%   TAB2 = TAB.groupByLevels(COLINDEX, OP)
